...
nnoremap <unique> <leader>f :FufTaggedFile<CR>
nnoremap <silent> <F6> :Rgrep<CR>
let Grep_Xargs_Path = "/usr/local/Cellar/findutils/4.4.2/bin/gxargs" 
let Grep_Skip_Files = '*.bak *~ tags filenametags *.o *.tmp *.svn-base *.png'
let Grep_Skip_Dirs = '~/Documents/projects/kbatterydoctor-jb/trunk/daemontweak/pxl/ ~/Documents/projects/kbatterydoctor-jb/trunk/daemontweak/_/ ~/Documents/projects/kbatterydoctor-jb/trunk/daemontweak/layout/ .svn /Users/acb/Documents/projects/kbatterydoctor-jb/trunk/daemontweak/_/ /Users/acb/Documents/projects/kbatterydoctor-jb/trunk/daemontweak/obj' 
...
au FileType c,cpp,java,javascript,objc set comments=sO:*\ -,mO:*\ \ ,exO:*/,s1:/*,mb:*,ex:*/,f:// 
...
" default languages
let g:ex_default_langs = ['c', 'cpp', 'c#', 'javascript', 'java', 'shader', 'python', 'lua', 'vim', 'uc', 'matlab', 'wiki', 'ini', 'make', 'sh', 'batch', 'debug', 'qt', 'swig','ObjectiveC' ] 
...
call exUtility#AddLangMap ( 'exvim', 'ObjectiveC', ['m'] )
call exUtility#AddLangMap ( 'exvim', 'ObjectiveC', ['mm'] )
call exUtility#AddLangMap ( 'exvim', 'ObjectiveC', ['xm'] )
...
" ctags -R --language-force=ObjectiveC 
function BuildTags() 
    !rm -f tags
    !rm -f filenametags
    !ctags -R --language-force=ObjectiveC --extra=+f
    !lt
    " !cp -f tags filenametags
endfunction
...
function g:exES_PostUpdate()
	...
	if exists( 'g:exES_LookupFileTag' LookupFileTag.'"'
        if exists(':LUCurFile')
...
let tlist_objc_settings    = 'ObjectiveC;i:interface;I:implementation;P:protocols;c:class;m:method;p:property'

let filetype_m='objc'
let filetype_mm='objc'
let filetype_xm='objc'


"local/Cellar/ctags/HEAD/bin/ctags"
...
endfunction8 
map :call ChangeFileTypeBetweenCppAndObjcpp()
